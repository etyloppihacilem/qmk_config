...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x5_2(
        ...
        // +---------------+---------------+---------------+-----------+--------|                      |-----------+-------------------+-------------------+-------------------+-----------------|
            KC_EXLM,        KC_AT,          KC_HASH,        KC_COLN,    KC_DLR,                         KC_AMPR,    KC_QUOT,            KC_LPRN,            KC_RPRN,            KC_BSLS,
        // +---------------+---------------+---------------+-----------+--------|                      |-----------+-------------------+-------------------+-------------------+-----------------|
            KC_CIRC,        KC_AMPR,        KC_ASTR,        KC_MINS,    KC_EQL,                         KC_LCBR,    KC_RCBR,            KC_LBRC,            KC_RBRC,            KC_GRV,
        // +---------------+---------------+---------------+-----------+--------|                      |-----------+-------------------+-------------------+-------------------+-----------------|
                                                                // ,------------------------.  ,-------------------.
                                                                    TG(4),          KC_LSFT,    KC_RSFT,    KC_NO
                                                                // '--------------+---------'  '----------+--------'
        ),
